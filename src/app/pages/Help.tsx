...
const faqContractor: FaqItem[] = [
  { q: 'Как начать работать?', a: 'Зарегистрируйтесь как исполнитель, укажите район и способ передвижения. Первый месяц — бесплатно. После этого вы сразу увидите доступные заказы рядом с вами.' },
  { q: 'Сколько стоит подписка?', a: 'Первый месяц бесплатно. Далее — 50 ₽/месяц. Если пригласите 5 активных друзей-исполнителей, подписка становится бесплатной навсегда. Оплата через СБП или картой.' },
  ...
  { q: 'Что делать если заказчик не подтверждает?', a: 'Через 24 часа заказ автоматически переходит в статус «ожидание оплаты», а ещё через 48 часов — завершается. Если есть проблемы, обратитесь в поддержку.' },
];
