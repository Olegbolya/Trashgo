                    ...
                    <div className="flex items-center justify-between gap-3 mb-4">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-sm mt-0.5" style={{ color: c.muted }}>{user?.phone || user?.email || '—'}</div>
                        </div>
                      </div>
                      <button
            ...
            <div className="p-5">
              ...
              {emailChangeStep === 'verify' ? (
                <>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        const res = await authApi.confirmEmailChange(editProfileForm.email.trim(), emailChangeCode);
                ...
                <>
                  ...
                  <button
                    disabled={editProfileSaving || !editProfileForm.name.trim() || (!editProfileForm.email.trim() && !!user?.email)}
                    onClick={async () => {
                      setEditProfileSaving(true);
                      try {
