...
const FAQ_ITEMS = [
  ...
  { q: 'Работает ли TrashGo на телефоне?', a: 'Да! Сайт полностью адаптирован для мобильных устройств. Добавьте trash-go.ru на главный экран телефона как PWA — работает как приложение, без установки из магазина.' },
];
