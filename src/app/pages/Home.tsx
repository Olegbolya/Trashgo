...
const FAQ_ITEMS = [
  { q: 'Как оставить заявку на вывоз мусора?', a: 'Выберите роль «Заказчик», войдите по email и нажмите «Создать заявку». Укажите адрес, объём и удобное время — исполнители в вашем районе увидят заявку и откликнутся.' },
  { q: 'Сколько стоит вывоз?', a: 'Вы сами указываете желаемую цену при создании заявки. Исполнители могут принять её или предложить свою стоимость — вы выбираете лучшее предложение.' },
  { q: 'Как быстро приедет исполнитель?', a: 'Обычно в тот же или следующий день. При создании заявки вы выбираете удобный временной слот, исполнитель подтверждает время и приезжает точно в срок.' },
  { q: 'Как стать исполнителем и начать зарабатывать?', a: 'Выберите роль «Исполнитель», зарегистрируйтесь и укажите свой район. После этого вы сразу увидите доступные заявки рядом с вами и сможете их принимать.' },
        ...
        <div style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: 'clamp(4rem,8vw,6rem) 1.5rem clamp(3rem,6vw,5rem)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%,320px), 1fr))', gap: '3rem', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 'clamp(0.9rem,1.4vw,1.05rem)', color: textSub, lineHeight: 1.7, maxWidth: 480, margin: '0 0 2rem' }}>
              Платформа для вывоза мусора. Найдите исполнителя рядом — или начните зарабатывать сами. Просто, надёжно, экологично.
            </p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
              {[['5,000+', 'Выполнено заказов'], ['500+', 'Исполнителей'], ['4.9 ★', 'Средний рейтинг']].map(([val, label], i) => (
          ...
          <div style={{ borderTop: '1px solid #1f2937', padding: '1.5rem 0 1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '0.5rem' }}>
              {[
                ...
                ['4', 'Защита данных', 'Серверы Railway, шифрование TLS 1.3, вход через OTP — пароли не хранятся.'],
