...
const FAQ_ITEMS = [
  { q: 'В каких районах Казани работает TrashGo?', a: 'TrashGo работает по всей Казани: Вахитовский, Ново-Савиновский, Советский, Приволжский, Московский, Авиастроительный и Кировский районы. Исполнители указывают свой рабочий район, и заявки показываются тем, кто рядом.' },
