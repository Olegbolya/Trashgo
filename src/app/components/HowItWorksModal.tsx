...
const CONTRACTOR_STEPS: Step[] = [
  { icon: '👀', title: 'Найдите подходящий заказ', desc: 'Откройте вкладку «Найти заказ» — там все доступные заявки из вашего района. Используйте фильтры по дате, времени и расстоянию.' },
  { icon: '🗺️', title: 'Проверьте маршрут', desc: 'В деталях заказа нажмите «Маршрут на карте» — увидите адрес на карте и сможете оценить расстояние до клиента.' },
  ...
  { icon: '🚛', title: 'Выполните работу', desc: 'Приедьте по адресу, заберите мешки с мусором и отнесите к ближайшему контейнеру. Можно общаться с клиентом в чате.' },
  ...
  { icon: '💰', title: 'Получите оплату', desc: 'Клиент подтверждает выполнение — деньги сразу зачисляются на ваш баланс в TrashGo. Выводите в любое время.' },
];
